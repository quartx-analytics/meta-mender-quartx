...
SRC_URI_append = " file://mender-inventory-iot-type file://update-module-docker-compose file://artifact-verify-key.pem"
...
do_install_append() {
    ...
    install -m 755 ${WORKDIR}/update-module-docker-compose ${D}/${datadir}/mender/modules/v3/docker-compose
}
